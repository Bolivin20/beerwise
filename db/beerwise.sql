...
values (70, 'Hazy Disco', 'pinta', 'ipa', '5.8%', 'Intensywne aromaty grejpfruta, mango, mandarynki i marakui. Kremowa faktura zapewniona przez użycie słodu pszenicznego i owsianego. Chmielowa lupulina Cryo Hops® z ostatniego zbioru nadaje piwu świeżości i soczystości.
       ...
       (69, 'Imperator Bałtycki', 'pinta', 'porter', '9.1%',
       ...
       (68, 'Pierwsza pomoc', 'PINTA', 'pils', '4.1%', 'Polski Lekki Pils, 10.5°Blg
        ...
        Pierwsza pomoc powszednia - co byś bez niej zrobił?! Do śniadania, do obiadu, do kolacji. Nie żałowaliśmy dobrego słodu, nie żałowaliśmy dobrego chmielu. PINTA Pierwsza Pomoc orzeźwia, syci, przywraca humor. Polecamy do użytku codziennego.',
       ...
       (66, 'Atak chmielu', 'PINTA', 'IPA', '6%',
        'PINTA Atak Chmielu 15,1° to fantazyjnie nachmielone piwo w stylu American India Pale Ale. Pierwsza AIPA z polskiego browaru. Atak Chmielu warzymy od 28 marca 2011 r. Nasza AIPA to czerwono-miedziane, treściwe piwo górnej fermentacji. Smak i aromat cytrusowy, kwiatowy, żywiczny, sosnowy i owocowy pochodzi od amerykańskiego chmielu. Atak Chmielu - tak się rozpoczyna rewolucje!',
        'beer-70951_70526_hd.jpeg', '2023-01-21', 11, 6.5),
       (77, 'Żubr', 'Kompania Piwowarska', 'lager', '6%',
       ...
       (75, 'Forest', 'NEPO', 'ipa', '5.5%',
        'Jasne piwo w stylu IPA o zdecydowanej goryczce. Gałązki sosny, jodły i świerku nadały piwu leśnego klimatu a dodatek amerykańskich chmieli uzupełnił je o nuty cytrusowe.',
